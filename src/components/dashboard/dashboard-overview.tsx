...
/**
 * The former standalone /dashboard page's content, extracted so it can be
 * embedded as the "總覽" tab of the merged Planning Operations Center hub
 * (dashboard + kanban + planning now live on one page, per the request to
 * stop splitting team-tracking overview across three separate screens).
 */
